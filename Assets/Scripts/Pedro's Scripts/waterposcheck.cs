...
public class waterposcheck : MonoBehaviour
{
    ...
    public bool watercheck = false; // Flag to check if the object is in water
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject == targetCube)
        {
            ...
            watercheck = true; // Set the watercheck flag to true
        ...
        else
        {
            ...
            watercheck = false; // Set the watercheck flag to true
        }
    }
}
